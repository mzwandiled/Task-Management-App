                    ...
                    <div class="card-body px-5 py-5">
                        ...
                        <form method="post" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control p_input" :value="__('Password')" name="password"
                                       required autocomplete="new-password" >
                            </div>
                              <div class="form-group">
                                <label>Confirm Password</label>
                                <input type="password" class="form-control p_input" :value="__('Confirm Password')" name="password_confirmation" required autocomplete="new-password" >
                            </div>
